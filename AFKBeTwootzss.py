...
@loader.tds
class AFKModTwootzss(loader.Module):
    """Provides a message saying that you are unavailable"""
    strings = {"name": "АФК",
               "gone": "<b>Я ушёл в АФК👋</b>",
               "back": "<b>Я вернулся с АФК👋</b>",
               "afk": "<b>Я в АФК (Времени в афк {} ⏰).</b>",
               "afk_reason": "<b>Я в АФК (Времени в афк {} ⏰).\nReason:</b> <i>{}</i>"}
    ...
    async def безафкcmd(self, message):
        """Убрать АФК статус"""
